...
[TestClass]
public class WarningTerminalTester
{
    [TestClass]
    public class Constructor : Tester<WarningTerminal>
    {
        [TestMethod]
        public void WhenBackgroundColorIsNullInSettings_UseGlobalDefaultColor()
        {
            //Arrange
            SetupOptions(Fixture.Create<TerminalSettings>() with { Warning = null });

            //Act
            //Constructor

            //Assert
            Instance.BackgroundColor.Should().Be(DefaultColors.Warning.Background!.Value);
        }
        ...
        public void WhenForeroundColorIsNullInSettings_UseGlobalDefaultColor()
        {
            ...
            //Assert
            Instance.ForegroundColor.Should().Be(DefaultColors.Warning.Foreground!.Value);
        }
        ...
        public void WhenBackgroundColorInSettingsIsNotNull_UseThat()
        {
            ...
            //Assert
            Instance.BackgroundColor.Should().Be(options.Warning!.Color!.Background!.Value);
        }
        ...
        public void WhenForegroundColorInSettingsIsNotNull_UseThat()
        {
            ...
            //Assert
            Instance.ForegroundColor.Should().Be(options.Warning!.Color!.Foreground!.Value);
        }
    }

    [TestClass]
    public class BackgroundColor : Tester<WarningTerminal>
    {
    ...
    [TestClass]
    public class ForegroundColor : Tester<WarningTerminal>
    {
        protected override void InitializeTest()
        {
            base.InitializeTest();
    ...
    [TestClass]
    public class Write : Tester<WarningTerminal>
    {
        [TestMethod]
        [DataRow("")]
        [DataRow(" ")]
    ...
    [TestClass]
    public class TryWrite : Tester<WarningTerminal>
    {
        [TestMethod]
        [DataRow("")]
        [DataRow(" ")]
    ...
    [TestClass]
    public class ResetColor : Tester<WarningTerminal>
    {
        [TestMethod]
