...
[TestClass]
public class ErrorTerminalTester
{
    [TestClass]
    public class Constructor : Tester<ErrorTerminal>
    {
        [TestMethod]
        public void WhenBackgroundColorIsNullInSettings_UseGlobalDefaultColor()
        {
            //Arrange
            SetupOptions(Dummy.Create<TerminalSettings>() with { Error = null });

            //Act
            //Constructor

            //Assert
            Instance.BackgroundColor.Should().Be(DefaultColors.Error.Background!.Value);
        }
        ...
        public void WhenForeroundColorIsNullInSettings_UseGlobalDefaultColor()
        {
            ...
            //Assert
            Instance.ForegroundColor.Should().Be(DefaultColors.Error.Foreground!.Value);
        }
        ...
        public void WhenBackgroundColorInSettingsIsNotNull_UseThat()
        {
            ...
            //Assert
            Instance.BackgroundColor.Should().Be(options.Error!.Color!.Background!.Value);
        }
        ...
        public void WhenForegroundColorInSettingsIsNotNull_UseThat()
        {
            ...
            //Assert
            Instance.ForegroundColor.Should().Be(options.Error!.Color!.Foreground!.Value);
        }
    }

    [TestClass]
    public class BackgroundColor : Tester<ErrorTerminal>
    {
    ...
    [TestClass]
    public class ForegroundColor : Tester<ErrorTerminal>
    {
        protected override void InitializeTest()
        {
            base.InitializeTest();
    ...
    [TestClass]
    public class Write : Tester<ErrorTerminal>
    {
        [TestMethod]
        [DataRow("")]
        [DataRow(" ")]
        ...
        public void WhenUsingTimestamps_IncludeTimestamps()
        {
            ...
            GetMock<IOptions<TerminalSettings>>().Setup(x => x.Value).Returns(options);
            var foregroundColor = options.Error!.Color!.Foreground!.Value;
    ...
    [TestClass]
    public class TryWrite : Tester<ErrorTerminal>
    {
        [TestMethod]
        [DataRow("")]
        [DataRow(" ")]
    ...
    [TestClass]
    public class ResetColor : Tester<ErrorTerminal>
    {
        [TestMethod]
        public void Always_ResetBackgroundColorToDefault()
        {
            ...
            //Assert
            Instance.BackgroundColor.Should().BeEquivalentTo(options!.Error!.Color!.Background);
        ...
        public void Always_ResetForegroundColorToDefault()
        {
            ...
            //Assert
            Instance.ForegroundColor.Should().BeEquivalentTo(options!.Error!.Color!.Foreground);
        }
    }
}